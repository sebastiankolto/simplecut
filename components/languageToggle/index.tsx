...
export default function LanguageToggle() {
  ...
  return (
    <Link
      ...
      className="h-11 w-21 border-1 flex relative items-center justify-center bg-white/5 border-1 border-white/20 backdrop-blur-md"
    >
      ...
      <span className="h-3.5 w-[2px] bg-white/50 flex absolute left-[39px]" />
    </Link>
  );
}
